...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        # Add by zc
        self.seg_embed = nn.Embedding(args.max_source_positions, args.encoder_embed_dim)
        nn.init.normal_(self.seg_embed.weight, mean=0, std=args.encoder_embed_dim ** -0.5)
    ...
    def forward_embedding(
        self, src_tokens, token_embedding: Optional[torch.Tensor] = None, indicator: Optional[torch.Tensor] = None,
    ):
    ...
    def forward_scriptable(
        ...
        x, encoder_embedding = self.forward_embedding(src_tokens, token_embeddings, indicator)
