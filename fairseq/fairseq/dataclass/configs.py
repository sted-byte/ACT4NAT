...
class CommonConfig(FairseqDataclass):
    ...
    with_multitask: int = field(
        default=0,
        metadata={
            "help": "training with multi-task"
        },
    )
    additional_str: str = field(
        default="",
        metadata={
            "help": "additional num for my test"
        }
    )
...
class CheckpointConfig(FairseqDataclass):
    ...
    small_dataset: int = field(
        default=0, metadata={"help": "0 for full train dataset, 1 for small train dataset"}
    )
